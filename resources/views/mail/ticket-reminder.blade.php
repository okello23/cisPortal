<h2>Reminder: Ticket {{ $ticket->ticket_number }} is still unresolved</h2>
...
<p><strong>Idle Time:</strong> {{ $ticket->last_worked_at?->diffForHumans(now(), ['parts' => 2, 'syntax' => \Carbon\CarbonInterface::DIFF_ABSOLUTE]) ?? 'More than 3 days' }}</p>
